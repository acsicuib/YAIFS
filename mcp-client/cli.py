...
SYSTEM_PROMPT = """
You are an assistant controlling a YAFS simulation through MCP tools.
...
def _render_welcome(
    ...
    *,
    ...
    capabilities = Text()
    capabilities.append("Controla simulaciones de un 'YAFS renovado' con tu idioma.\n", style="white")
    capabilities.append("Explora laboratorios, crea simulaciones, ejecuta forks, pausa/reanuda y analiza metricas.\n", style="white")
    console.print(
        Panel(
            Text.assemble(logo, "\n", subtitle, "\n\n", capabilities),
            # border_style="cyan",
    ...
    info_lines = [
        ...
        "- Usa [cyan]/tools[/cyan] para ver herramientas MCP disponibles.",
        "- Usa [cyan]/lab /ruta/al/lab[/cyan] para fijar un escenario durante la sesion.",
        "- Pide acciones como ejecutar, pausar, clonar o inspeccionar la simulacion.",
    ]
    if has_lab_path:
        info_lines.append("- Esta sesion arranca con un [cyan]lab-path[/cyan] ya definido.")
        ...
        console.print(
            Panel(
                Syntax(
                    ...
                    "you> crea una simulacion llamada demo y ejecutala 500 unidades\n"
                    "you> haz un fork y elimina un cluster para comparar metricas",
                    "text",
                    theme="ansi_dark",
                    line_numbers=False,
                ),
    ...
    async def ask(self, prompt: str) -> str:
        ...
        while True:
            ...
            if not function_calls:
                ...
                if not final_text:
                    final_text = "(sin respuesta de texto)"
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--tool-log-file",
        default="mcp-client/tool_calls.jsonl",
